...
const Services = () => {
    return <section className='mb-12 xl:mb-36'>
        ...
        <h2 className='section-title mb-12 xl:mb-24 mx-auto text-center sm:text-left'>My services</h2>
            {/* grid items */}
                ...
                {servicesData.map((item, index) => {
                    return <Card className='w-full max-w-[424px] h-[300px] flex flex-col pt-16 pb-10 justify-center items-center relative'
                        ...
                        <CardHeader className='text-primary absolute -top-[60px]'>
                            <div className='w-[148px] h-[88px] bg-white dark:bg-background flex justify-center items-center'>{item.icon}</div>
                        </CardHeader>
